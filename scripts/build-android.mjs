...
// 创建简单的gradlew脚本用于初始化
const gradlewInit = `#!/bin/bash
# 初始化Gradle Wrapper
if [ ! -f "gradle/wrapper/gradle-wrapper.jar" ]; then
    echo "下载Gradle Wrapper..."
    curl -L https://github.com/gradle/gradle/raw/v8.5.0/gradle/wrapper/gradle-wrapper.jar -o gradle/wrapper/gradle-wrapper.jar
fi
...
if [ -f "gradle/wrapper/gradle-wrapper.jar" ]; then
    ...
    echo "错误: 无法找到gradle-wrapper.jar"
    exit 1
fi
`
fs.writeFileSync(`${androidDir}/gradlew`, gradlewInit)
